<?php
/*
Plugin Name: boma delivery plugin
Plugin URI: https://github.com/boma1able/boma-delivery-plugin
Description: this plugin for woocommercer delivery
Author: boma
...
if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
    ...
    function activation(){
        deactivate_plugins('boma-delivery-plugin/boma-delivery-plugin.php');
